...
public class EditCollectionHandler : IRequestHandler<EditCollectionCommand, object>
{
    private readonly AppDbContext _context;
    private readonly IEfRepository<Article> _efRepository;
    private readonly IMapper _mapper;

    public EditCollectionHandler(AppDbContext context,
    ...
    public async Task<object> Handle(EditCollectionCommand request, CancellationToken cancellationToken)
    {
