        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Collections_User_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InteractorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ArticleId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Interactions_User_InteractorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContributorsArticles_ContributorsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interactions_ArticleId",
                table: "Interactions",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_Interactions_InteractorId",
                table: "Interactions",
                column: "InteractorId");
